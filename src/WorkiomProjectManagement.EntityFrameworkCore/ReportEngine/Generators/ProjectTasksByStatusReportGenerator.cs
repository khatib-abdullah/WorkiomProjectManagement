...
public class ProjectTasksByStatusReportGenerator : ProjectReportGeneratorBase
{
    public override string ProjectReportSystemName => "project_tasks_by_status";
    ...
    public ProjectTasksByStatusReportGenerator(
        IProjectTaskRepository projectTaskRepository,
        IStringLocalizer<WorkiomProjectManagementResource> localizer) : base(localizer)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new ProjectReportResult
        {
            ...
            Labels = [.. grouped.Select(g => L[$"Enum:TaskStatus:{g.Status}"].Value)],
            Series =
            [
                new()
                {
