...
public class WorkiomProjectManagementEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<WorkiomProjectManagementDbContext>(options =>
        {
            ...
            options.AddRepository<ProjectMember, ProjectMemberRepository>();
            options.AddRepository<ProjectTask, ProjectTaskRepository>();
        });
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also WorkiomProjectManagementDbContextFactory for EF Core tooling. */
