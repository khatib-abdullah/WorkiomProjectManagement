...
{
    [DbContext(typeof(WorkiomProjectManagementDbContext))]
    [Migration("20260312104041_AddProjectAndTaskAggregates")]
    partial class AddProjectAndTaskAggregates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkiomProjectManagement.ProjectManagement.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkiomProjectManagement.ProjectManagement.ProjectMember", b =>
                {
            ...
            modelBuilder.Entity("WorkiomProjectManagement.ProjectManagement.ProjectTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkiomProjectManagement.ProjectManagement.ProjectTaskAssignmentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppProjectTaskAssignmentHistory", (string)null);
                });

            modelBuilder.Entity("WorkiomProjectManagement.ProjectManagement.ProjectTaskStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppProjectTaskStatusHistory", (string)null);
                });
            ...
            modelBuilder.Entity("WorkiomProjectManagement.ProjectManagement.ProjectMember", b =>
                {
                    b.HasOne("WorkiomProjectManagement.ProjectManagement.Project", null)
                        .WithMany("Members")
            ...
            modelBuilder.Entity("WorkiomProjectManagement.ProjectManagement.ProjectTaskAssignmentHistory", b =>
                {
                    b.HasOne("WorkiomProjectManagement.ProjectManagement.ProjectTask", null)
