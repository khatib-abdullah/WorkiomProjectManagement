...
public class WorkiomProjectManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public WorkiomProjectManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
